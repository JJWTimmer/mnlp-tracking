class app.Defaults
  ...
  #center of the map
  centerLongitude: 35.320333
  centerLatitude: -1.392895

  #corners of the map
  minLat: 35.14455174999947
  minLon: -1.4807579817798406
  maxLat: 35.496114249999806
  maxLon: -1.3050287418975504

  zoom: 12

  #color ramp with distinct colors
  colors: ["#00FF00", "#0000FF", "#FF0000", "#01FFFE", "#FFA6FE", "#FFDB66", "#006401", "#010067", "#95003A", "#007DB5",
           "#FF00F6", "#FFEEE8", "#774D00", "#90FB92", "#0076FF", "#D5FF00", "#FF937E", "#6A826C", "#FF029D", "#FE8900",
